...
var callbackButton = document.querySelector('.side-menu__call-button');
var modalCallback = document.querySelector('.overlay-modal-callback');

var closeSideMenu = function closeSideMenu(event) {
  var target = event.target;

  if (target === modalCallback || target.closest('.callback-close-button')) {
...
var openSideMenu = function openSideMenu() {
  modalCallback.style.visibility = 'visible';
  modalCallback.style.opacity = 1;
};

callbackButton.addEventListener('click', openSideMenu);
modalCallback.addEventListener('click', closeSideMenu);

/***/ }),

/***/ "./src/js/_modal-feedback.js":
/*!***********************************!*\
  !*** ./src/js/_modal-feedback.js ***!
  \***********************************/
/*! no static exports found */
...
var feedbackButton = document.querySelector('.side-menu__chat-button');
var modalFeedback = document.querySelector('.overlay-modal-feedback');

var closeSideMenu = function closeSideMenu(event) {
  var target = event.target;

  if (target === modalFeedback || target.closest('.feedback-close-button')) {
    modalFeedback.style.opacity = 0;
    setTimeout(function () {
      modalFeedback.style.visibility = 'hidden';
    }, 300);
  }
};
...
feedbackButton.addEventListener('click', openSideMenu);
modalFeedback.addEventListener('click', closeSideMenu);

/***/ }),

/***/ "./src/js/_show-more-button.js":
/*!*************************************!*\
  !*** ./src/js/_show-more-button.js ***!
  \*************************************/
/*! no static exports found */
...
var brandMoreButton = document.querySelector('.brandMoreButton');
var brandWrapper = document.querySelector('.brand');
var typeMoreButton = document.querySelector('.typeMoreButton');
var typeWrapper = document.querySelector('.type');

function showMoreButton(section, wrapper) {
  var showMoreButtonElements = section.querySelectorAll('.showMoreButton__element');
  var button = section.querySelector('.showMoreButton__button');
  var image = section.querySelector('.showMoreButton__image');
  var swiperWrapper = wrapper.querySelector('.swiper-wrapper');

  for (var i = 0; i < showMoreButtonElements.length; i++) {
...
showMoreButton(brandMoreButton, brandWrapper);
showMoreButton(typeMoreButton, typeWrapper);

/***/ }),

/***/ "./src/js/_side-menu.js":
/*!******************************!*\
  !*** ./src/js/_side-menu.js ***!
  \******************************/
/*! no static exports found */
...
var burgerButton = document.querySelector('.header__menu-button');
var sideMenu = document.querySelector('.overlay-side-menu');

var closeSideMenu = function closeSideMenu(event) {
  var target = event.target;

  if (target === sideMenu || target.closest('.side-menu__burger-button')) {
...
var enableSwiper = function enableSwiper() {
  mySwiperPrice = new _node_modules_swiper_swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.price', {
    loop: true,
    breakpoints: {
      320: {
        slidesPerView: 1.2,
...
var breakpointChecker = function breakpointChecker() {
  if (breakpoint.matches === true) {
    if (mySwiperType !== undefined) mySwiperType.destroy(true, true);
    return;
  } else if (breakpoint.matches === false) {
    return enableSwiper();
  }
...
var enableSwiper = function enableSwiper() {
  mySwiperType = new _node_modules_swiper_swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.type', {
    loop: true,
    breakpoints: {
      320: {
        slidesPerView: 1.25,
...
var enableSwiper = function enableSwiper() {
  mySwiper = new _node_modules_swiper_swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.brand', {
    loop: true,
    breakpoints: {
      320: {
        slidesPerView: 1.25,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modal_callback_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_modal-callback.js */ "./src/js/_modal-callback.js");
/* harmony import */ var _modal_callback_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modal_callback_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _modal_feedback_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_modal-feedback.js */ "./src/js/_modal-feedback.js");
/* harmony import */ var _modal_feedback_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_modal_feedback_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _show_more_button_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./_show-more-button.js */ "./src/js/_show-more-button.js");
/* harmony import */ var _show_more_button_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_show_more_button_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _side_menu_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./_side-menu.js */ "./src/js/_side-menu.js");
...
/* harmony import */ var _swiper_price_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./_swiper-price.js */ "./src/js/_swiper-price.js");
/* harmony import */ var _swiper_type_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./_swiper-type.js */ "./src/js/_swiper-type.js");
/* harmony import */ var _swiper_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./_swiper.js */ "./src/js/_swiper.js");
